...
namespace CryptoAlertCore.CryptoInformation.DTO
{
    public partial class Welcome
    {
        ...
        public object[] SponosoredNews { get; set; }
    ...
    public enum PreMinedValue { DPoR, DPoS, DPoSLPoS, DPoWPoW, Dpos, EPoW, HPoW, LPoS, Lft, LimitedConfidenceProofOfActivity, MFba, NA, PoA, PoB, PoBPoS, PoBh, PoC, PoI, PoP, PoPPoVPoQ, PoPp, PoR, PoS, PoSLPoS, PoSPoB, PoSPoD, PoSPoP, PoSPoW, PoSPoWPoT, PoSign, PoSt, PoW, PoWAndPoS, PoWDPoW, PoWHiPoS, PoWNPoS, PoWPoMPoSii, PoWPoS, PoWPoSPoC, PoWPoW, PoWPoZ, PoWt, PowPoS, PowPoSc, PreMinedValuePoS, PreMinedValuePoWPoS, ProofOfOwnership, ProofOfStake, PurplePoWPoS, ScryptAdaptiveNAsicResistant, TPoS, Tangle, ZeroKnowledgeProof };
